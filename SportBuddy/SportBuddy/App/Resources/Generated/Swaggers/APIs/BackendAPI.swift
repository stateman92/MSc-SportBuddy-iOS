...
open class BackendAPI {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func exerciseDelete(exerciseId: UUID, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
        exerciseDeleteWithRequestBuilder(exerciseId: exerciseId).execute { (response, error) -> Void in
            if error == nil {
                completion((), error)
            } else {
                completion(nil, error)
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func exercisePost(exercise: ExerciseDTO, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
        exercisePostWithRequestBuilder(exercise: exercise).execute { (response, error) -> Void in
            if error == nil {
                completion((), error)
            } else {
                completion(nil, error)
    ...
    open class func exercisePostWithRequestBuilder(exercise: ExerciseDTO) -> RequestBuilder<Void> {
        let path = "/exercise"
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = JSONEncodingHelper.encodingParameters(forEncodableObject: exercise)
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func exercisePut(exerciseId: UUID, exercise: ExerciseDTO, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
        exercisePutWithRequestBuilder(exerciseId: exerciseId, exercise: exercise).execute { (response, error) -> Void in
            if error == nil {
                completion((), error)
            } else {
                completion(nil, error)
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func exercisePutWithRequestBuilder(exerciseId: UUID, exercise: ExerciseDTO) -> RequestBuilder<Void> {
        let path = "/exercise"
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = JSONEncodingHelper.encodingParameters(forEncodableObject: exercise)
